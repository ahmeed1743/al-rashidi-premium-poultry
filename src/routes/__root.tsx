...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "طيور الرشيدي: فراخ بيضاء وبلدي، بط، رومي، أرانب، متبلات وواجبات. جودة فاخرة وتوصيل سريع." },
      { name: "author", content: "طيور الرشيدي" },
      { property: "og:title", content: "طيور الرشيدي — دواجن طازجة وعروض يومية" },
      { property: "og:description", content: "طيور الرشيدي: فراخ بيضاء وبلدي، بط، رومي، أرانب، متبلات وواجبات. جودة فاخرة وتوصيل سريع." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "طيور الرشيدي — دواجن طازجة وعروض يومية" },
      { name: "twitter:description", content: "طيور الرشيدي: فراخ بيضاء وبلدي، بط، رومي، أرانب، متبلات وواجبات. جودة فاخرة وتوصيل سريع." },
