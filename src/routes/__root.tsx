...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "الموقع الرسمي لطيور الرشيدي. نوفر الدواجن الطازجة والمنتجات المجهزة بأعلى معايير الجودة، مع عروض متجددة، طلب أونلاين سريع، تحديث فوري للأسعار، وتوصيل موثوق لتجر" },
      { name: "author", content: "طيور الرشيدي" },
      { property: "og:title", content: "طيور الرشيدي — دواجن طازجة وعروض يومية" },
      { property: "og:description", content: "الموقع الرسمي لطيور الرشيدي. نوفر الدواجن الطازجة والمنتجات المجهزة بأعلى معايير الجودة، مع عروض متجددة، طلب أونلاين سريع، تحديث فوري للأسعار، وتوصيل موثوق لتجر" },
